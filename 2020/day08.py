...
for line in code.splitlines():
    op, arg = line.split()
    original_instructions.append((op, int(arg)))


class ExecutionFinished(StopIteration):
    pass
...
class CPU:
    ...
    def step(self):
        ...
        if self.ip in self.visited_instructions:
            raise InfiniteLoop()

        self.visited_instructions.add(self.ip)
...
for i, (op, arg) in enumerate(original_instructions):
    ...
    instructions[i] = ({'jmp': 'nop', 'nop': 'jmp'}[op], arg)
